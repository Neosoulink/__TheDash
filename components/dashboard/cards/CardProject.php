<div class="card-project">
	...
	<div class="card-body">
		...
		<div class="footer">
			...
			<div>
				<a :href="optionItems ? 'http://' + item?.name + '.' + optionItems.domainVirtualHost : item?.project_url" :target="optionItems.openWithBlank ? 'blank_' : ''" class="btn btn-light btn-circle-icon"><span class="text-accent material-icons icon">visibility</span></a>
